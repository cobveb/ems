...
class ApplicationPartForm extends Component {
    ...
    render(){
        const { classes, isLoading, open, handleSubmit, pristine, submitting, invalid, submitSucceeded, action, vats, initialValues, applicationStatus } = this.props;
        return(
            <>
                <Dialog
                    open={open}
                                    ...
                                    <Grid item xs={2}>
                                        <FormSelectField
                                            ...
                                            disabled={applicationStatus !== undefined && applicationStatus.code !== 'ZP' ? true :
                                                this.props.groupVat !== undefined ? true : false}
                                        />
                                    </Grid>
                                    <Grid item xs={5}>
                                        <FormAmountField
