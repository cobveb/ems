...
class ApplicationContainer extends Component {
    ...
    handleSaveApplication = (values) => {
        this.props.loading(true)
            ...
            PublicProcurementApplicationApi.saveApplication(this.props.action, payload)
            .then(response => {
                this.setState( prevState => {
    ...
    render(){
        const { action, isLoading, estimationTypes, vats, coordinators, modes } = this.props;
        const { initData, planPositions } = this.state;
        return(
            <Application
                isLoading={isLoading}
