                            ...
                            <Grid container spacing={1} className={classes.container}>
                                ...
                                <Grid item xs={12} >
                                    ...
                                    <FormTableField
                                        ...
                                        toolbar={true}
                                        addButtonProps={{
                                            disabled : initialValues.status === undefined && true,
                                        }}
                                        editButtonProps={{
                                        ...
                                        deleteButtonProps={{
                                            disabled : selectedGroup.length > 0 ? false : true,
                                        }}
                                ...
                                <Grid item xs={9}>
                                    <FormSelectField
                                        ...
                                        disabled={this.props.initialValues.assortmentGroups !== undefined && this.props.initialValues.assortmentGroups.length < 2 ? true : false}
                                        isRequired={initialValues.status !== undefined ? true : null }
                                    />
                                </Grid>
                                <Grid item xs={6}>
                                    ...
                                    <>
                                        ...
                                        <Grid item xs={12}>
                                            <FormCheckBox
                                                ...
                                                disabled={this.props.initialValues.parts.length > 0}
                                            />
                                        </Grid>
                                    </>
                                }
                                    ...
                                    <>
                                        ...
                                        <Grid item xs={12} sm={12} >
                                            <FormTableField
                                                ...
                                                toolbar={true}
                                                addButtonProps={{
                                                    disabled: formCurrentValues.orderValueNet === undefined ?
                                                        true :
                                                ...
                                                editButtonProps={{
                                                    ...
                                                    icon: <Edit/>,
                                                    variant: "edit",
                                                    disabled: selectedPart.length > 0 && formCurrentValues.orderValueNet === undefined ? true : false,
                                                }}
                                                deleteButtonProps={{
                                ...
                                <Grid item xs={12} >
                                    ...
                                    <FormTableField
                                        ...
                                        editButtonProps={{
                                            ...
                                            icon: <Edit/>,
                                            variant: "edit",
                                            disabled: selectedCriterion.length > 0 ? false : true,
                                        }}
                                        deleteButtonProps={{
                                            disabled : selectedCriterion.length > 0 ? false : true,
                                        }}
