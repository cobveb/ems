                        ...
                        >
                            <Grid item xs={12} >
                                <Typography variant='h6'>
                                    {constants.EMPLOYEE_EMPLOYMENT_DETAILS_AUTHORIZATION_TITLE}
                                </Typography>
                                ...
                                <Grid container spacing={1} justify="center" className={classes.container}>
                                    ...
                                    <Grid item xs={3} >
                                        <FormDateField
                                            ...
                                            label={constants.EMPLOYEE_EMPLOYMENT_DETAILS_AUTHORIZATION_VERIFICATION_DATE}
                                            isRequired={true}
                                        />
                                    </Grid>
                                    <Grid item xs={12}>
                                        <FormDictionaryField
                                            ...
                                            dictionaryName={constants.EMPLOYEE_EMPLOYMENT_DETAILS_AUTHORIZATION_PROCESSING_BASIS_DICTIONARY}
                                            label={constants.EMPLOYEE_EMPLOYMENT_DETAILS_AUTHORIZATION_PROCESSING_BASIS}
                                            items={this.props.processingBases}
                                            isRequired={true}
                                        />
                                    </Grid>
                                    <Grid item xs={12} >
