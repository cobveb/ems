...
class ApplicationAssortmentGroupsForm extends Component {
    ...
    render(){
        const { classes, open, handleSubmit, pristine, submitting, invalid, submitSucceeded, planPositions, vats, orderGroupValueNet, applicationProcurementPlanPosition, applicationStatus } = this.props;
        return(
            <>
                <Dialog
                    open={open}
                            ...
                            <Grid container spacing={1} justify="center" className={classes.container}>
                                ...
                                <Grid item xs={6}>
                                    <FormAmountField
                                        ...
                                        isRequired={true}
                                        disabled={applicationStatus !== undefined && applicationStatus.code !== 'ZP' ? true :
                                            orderGroupValueNet === undefined ? true : false}
                                    />
                                </Grid>
                                <Grid item xs={6}>
                                    <FormAmountField
