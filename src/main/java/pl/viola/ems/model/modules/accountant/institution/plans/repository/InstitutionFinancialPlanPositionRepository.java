...
@Repository
public interface InstitutionFinancialPlanPositionRepository extends JpaRepository<InstitutionFinancialPlanPosition, Long> {
    InstitutionPlanPosition findByCostType(CostType costType);
